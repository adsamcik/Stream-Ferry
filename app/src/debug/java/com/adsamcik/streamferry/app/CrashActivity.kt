...
/**
 * DEBUG-ONLY full-screen crash report. Launched immediately by [com.adsamcik.streamferry.diagnostics.CrashReporter]
    ...
    Scaffold(topBar = { TopAppBar(title = { Text("Crash report (debug)") }) }) { padding ->
        Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                OutlinedButton(onClick = { saveLauncher.launch("stream-ferry-crash.txt") }) { Text("Save") }
            }
