...
import com.videobridge.core.adaptive.AdaptiveBitrateController
import com.videobridge.core.adaptive.BitrateLadder
import com.videobridge.core.stream.AudioTrackSelection
import com.videobridge.core.language.LanguageMatcher
import com.videobridge.core.language.TrackLanguage
...
import com.videobridge.core.segments.MediaSegmentTracker
import com.videobridge.data.transcode.ClientTranscodeSession
import com.videobridge.data.jellyfin.DeviceProfiles
import com.videobridge.data.transcode.LocalMediaProbe
...
class PlaybackEngine(
    ...
    private fun deviceEncodeCapsSummary(): String {
        ...
        fun t(r: com.videobridge.core.transcode.ResolutionTier?) = r?.let { "${it.maxHeightPx}p" } ?: "no"
