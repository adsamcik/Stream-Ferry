 ...
 * (the in-memory ring in [com.adsamcik.streamferry.logging.RedactingLogger] is wiped on process death — which is
 ...
 * toolchain; the Android glue ([com.adsamcik.streamferry.diagnostics.DiagnosticsEventLog]) points this at
