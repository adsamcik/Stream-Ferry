...
### Added
- Added a private playback-history screen under Settings for up to 20 renderer-confirmed Jellyfin,
  downloaded, and local items, with exact left-off progress, resume/watch-again actions, and per-item
  or full clearing.
